...
define([],function(angular){
  ...
  return ['$scope', '$rootScope', '$location', 'USER_ROLES', 'ERROR_MESSAGES', 'AuthService', 'MessageService',
   function ($scope, $rootScope, $location, USER_ROLES, ERROR_MESSAGES, AuthService, MessageService) {
